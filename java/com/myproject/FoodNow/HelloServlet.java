...
public class HelloServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        PrintWriter out = response.getWriter();//destination is response body
        out.println("<html><body>");
        out.println("<h1>Hello " + customer + "</h1>");
        out.println("</body></html>");
*/
        /*response.setContentType("application/json"); //inform frontend that I am going to return JSON to you

        JSONObject customer = new JSONObject();//JSONObject is actually a hashmap
        customer.put("email", "sun@laioffer.com");
        customer.put("first_name", "rick");
        customer.put("last_name", "sun");
        customer.put("age", 50);
        response.getWriter().print(customer);//actually print(customer.toString());
        */
        ...
        //Json can print an object out to string//serialization?
